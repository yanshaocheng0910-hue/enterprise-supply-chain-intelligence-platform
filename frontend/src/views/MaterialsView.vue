<template>
  <div>
    ...
    <section class="surface material-table">
      ...
      <div v-else-if="!filteredMaterials.length"><EmptyState title="没有匹配的物料" description="调整筛选条件，或新增一条物料主档。" action-text="新增物料" @action="openCreate" /></div>
...
function openCreate() { editing.value = false; Object.assign(form, { id: '', code: '', name: '', specification: '', unit: '', category: '', safetyStock: 0, minOrderQty: 1, packSize: 1, standardPrice: 0, leadTimeDays: 1, status: 'ACTIVE' }); dialogVisible.value = true }
