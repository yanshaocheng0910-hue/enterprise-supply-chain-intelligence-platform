<template>
  <div>
    ...
    <section class="surface supplier-table">
      ...
      <div v-else-if="!filteredSuppliers.length"><EmptyState title="没有匹配的供应商" description="调整筛选条件，或新增一条供应商主档。" action-text="新增供应商" @action="openCreate" /></div>
...
function openCreate() { editing.value = false; Object.assign(form, { id: '', code: '', name: '', category: '', contactName: '', contactPhone: '', status: 'PENDING' }); dialogVisible.value = true }
