...
## 2026-09-22（Asia/Shanghai）— 按原模板填充开题报告

- 根据用户要求只处理开题报告模板，不把论文范文、文献综述等参考材料混入开题报告版式。
- 直接复制 D 盘参考副本 `converted/template_guidelines.docx`，填入任务书中的题目、学生信息、导师信息和联系方式，并在原有五个栏目中写入精简内容。
- 新稿为 `docs/08-course-deliverables/06_开题报告_按原模板_2026-09-22.docx`，保留原模板 3 页表格和审核栏；Word 转 PDF 后完成 3 页视觉检查。
- 上一版自定义排版已移入 `.data/work/archive/custom-proposal-20260922`，不再作为正式开题报告。
